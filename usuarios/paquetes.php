...
<body>
    ...
    <header class="hero" id="inicio">
        ...
        <section class="container hero_main">
            ...
            <h1 class="title"> Elige el mejor <span class="title_active">Paquete</span></h1>
                ...
                if(!$connection) {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            echo '<th>ID</th> <th>LUGAR</th> <th>ESTADO</th><th>DIAS</th><th>HOTEL</th><th>VUELO</th><th>COSTO</th> ';
