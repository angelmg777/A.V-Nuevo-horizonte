            ...
            <article class="container-cards">
                <div class="card">
                    ...
                    <div class="card_text">
                        ...
                        <div> </div>
                        <a href="../destinosPHP/puebla.php" class="card_button">Más Detalles</a>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card_text">
                        ...
                        <div> </div>
                        <a href="../destinosPHP/mazatlan.php" class="card_button">Más Detalles</a>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card_text">
                        ...
                        <div> </div>
                        <a href="../destinosPHP/escondido.php" class="card_button">Más Detalles</a>
                    </div>
                </div>
            </article>
        </div>
            ...
            <article class="container-cards">
                <div class="card">
                    ...
                    <div class="card_text">
                        ...
                        <div> </div>
                        <a href="../destinosPHP/cozumel.php" class="card_button">Más Detalles</a>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card_text">
                        ...
                        <div> </div>
                        <a href="../destinosPHP/monterrey.php" class="card_button">Más Detalles</a>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card_text">
                        ...
                        <div> </div>
                        <a href="../destinosPHP/acapulco.php" class="card_button">Más Detalles</a>
                    </div>
                </div>
            </article>
        </div>
