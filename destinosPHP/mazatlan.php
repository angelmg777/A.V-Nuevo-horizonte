...
<body>
    ...
    <header class="hero" id="inicio">
        ...
        ?>
            ...
            <h1 class="tit">Mazatlan, Sinaloa</h1>

        <section class="container hero_main">

            <div class="texto">
                <h1 class="title"><span class="title_active">Hotel Riu Emerald Bay 5</span></h1>
                <p class="copy">Las habitaciones están decoradas con mobiliario cálido, y cuentan con balcón o terraza, Wi-Fi, TV de pantalla plana, minibar y caja fuerte. Las habitaciones mejoradas incluyen vista al océano, sofá cama o tienen dos niveles. 
                    <span class="copy_active"></span></p>
                    <p class="copy">Se incluyen el estacionamiento y las comidas y bebidas de 4 restaurantes y 5 bares. Los servicios constan de 3 piscinas, tina, club infantil, área de juegos, discoteca, gimnasio y spa con sauna
                        <span class="copy_active"></span></p>
                    <h3>
    ...
    <div class="containe">
        ...
        <ul class="slider">
          <li id="slide1">
            <img src="../css/images/maza.jpeg"/>
          </li>
          <li id="slide2">
            <img src="../css/images/maza2.jpeg"/>
          </li>
          <li id="slide3">
            <img src="../css/images/maza3.webp"/>
          </li>
          <li id="slide4">
            <img src="../css/images/maza4.jpeg"/>
          </li>
          <li id="slide5">
            <img src="../css/images/maza5.webp"/>
          </li>
        </ul>
